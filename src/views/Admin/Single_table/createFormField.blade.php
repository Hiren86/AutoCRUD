        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12" id="createFormFieldDiv">
                    <form action="{{ url('designForm') }}" method="post" role="form">
                        <fieldset>
                            <div class="clearfix"></div>
                            <?php $i=0; ?>
                            @foreach($columns as $item)
                                <h5 class="text-success"><input type="text" name="field-lbl{{$i}}" id="" value="{{ str_replace('_', " ",$item) }}" class="custom-lbl"></h5>
                                <div class="row">
